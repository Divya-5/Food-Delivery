...
const restaurantList = [
  ...
  },
  {
    ...
    data: {
      ...
      cityState: "15",
      address:
        "Shop no 5 Near K D Singh Babu Stadium Hazratganj lucknow.226001",
  ...
  },
  {
    ...
    data: {
      ...
      cuisines: ["Snacks", "Chinese", "Desserts"],
      tags: [],
      costForTwo: 20000,
      costForTwoString: "₹200 FOR TWO",
      deliveryTime: 36,
  ...
  },
  {
    ...
    data: {
      ...
      cityState: "15",
      address:
        "1/1155, Vishal Khand, Near St. Joseph Hospital, Gomti Nagar, Lucknow, Uttar Pradesh 226010",
  ...
  },
  {
    ...
    data: {
      ...
      slugs: {
        restaurant:
          "kwality-wall’s-frozen-dessert-&-ice-cream-shop-hazratganj-hazratganj",
        city: "lucknow",
      },
      cityState: "15",
      address:
        "GOLDI ICE CREAM: SHOP NO-1 NEW MARKET HAZRATGANJ LUCKNOW, Nagar Nigam Food Safety Zone-2, Lucknow, Uttar Pradesh-226001 (HUL- I370915P592)",
  ...
  },
  {
    ...
    data: {
      ...
      cuisines: ["American", "Indian", "Snacks", "Desserts", "Beverages"],
      tags: [],
      costForTwo: 30000,
      costForTwoString: "₹300 FOR TWO",
      deliveryTime: 29,
...
const Body = () => {
  return (
    <div className="restaurant-list">
          <RestaurantCard name={restaurantList[0].data.name} cuisines={restaurantList[0].data.name}/>
          <RestaurantCard name={restaurantList[1].data.name} name={restaurantList[0].data.name} />
