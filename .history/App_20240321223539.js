...
const Title = () => (
    ...
    // </h1>
    <a href="">
        <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsRDkQoLVDDilFi-J1TbbGr5Xf3YCRP3UjKg&usqp=CAU" alt="logo" />
    </a>
)
const Header = () => {
    return (
...
const RestaurantCard = ({ restaurant }) => {
    const { cloudinaryImageId,name, cuisines, las} = restaurant
    return (
        <div className="card">
